...
@interface SCEthosTests : XCTestCase

@property (nonatomic, strong) UITextView *textView;

@end

@implementation SCEthosTests
...
- (void) testTextView {
    XCTAssertNotNil(self.textView, @"Textview is nil %p", self.textView);
    ...
    XCTAssertTrue(self.textView.text.length == attributedString.length, @"TextView's text is different to the attributed string");
}
